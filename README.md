...
⬇️ **[Download Marrow.app.zip](https://github.com/benmaier/marrow/releases/download/v0.1.4/Marrow.app.zip)** (Apple Silicon M1/M2/M3/M4)
...
> ```
> Otherwise macOS will claim the app is "damaged". Intel Macs need to [build from source](#build-from-source).
